...
<div id="crear">
	...
	<div id="formcrear">
		<form method="post" action="" onsubmit="validacion()">
			...
			<input class="boton" id="enviarnota" type="submit" value="Crear"
				name="enviarnota"></input> <input class="boton" id="limpiar"
				type="reset" value="Limpiar datos" name="limpiar"></input>
		</form>
